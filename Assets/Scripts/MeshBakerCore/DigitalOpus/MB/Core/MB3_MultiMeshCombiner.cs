...
namespace DigitalOpus.MB.Core
{
	...
	public class MB3_MultiMeshCombiner : MB3_MeshCombiner
	{
		...
		{
			Apply(triangles, vertices, normals, tangents, uvs, uv2, uv3, uv4, uv5: false, uv6: false, uv7: false, uv8: false, colors, bones, blendShapeFlag, uv2GenerationMethod);
		}
		...
		public override bool AddDeleteGameObjectsByID(GameObject[] gos, int[] deleteGOinstanceIDs, bool disableRendererInSource = true)
		{
			...
			{
				MB2_Log.LogDebug("MB2_MultiMeshCombiner.AddDeleteGameObjects numCombinedMeshes: " + meshCombiners.Count + " added:" + gos.Length + " deleted:" + deleteGOinstanceIDs.Length + " disableRendererInSource:" + disableRendererInSource.ToString() + " maxVertsPerCombined:" + _maxVertsInMesh);
			}
